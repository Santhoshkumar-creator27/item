...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['updateProfilePhoto'])) {
        ...
        if($check !== false) {
            ...
            $uploaddir = $_SERVER['DOCUMENT_ROOT'].'/e-commerce/afvegetables/img/';
    ...
    if(isset($_POST['removeProfilePhoto'])) {
        $id = $_POST["userId"];
        $filename = $_SERVER['DOCUMENT_ROOT']."/e-commerce/afvegetables/img/person-".$id.".jpg";
