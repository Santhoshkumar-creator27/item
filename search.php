            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/cardd-'.$catId. '.png" class="card-img-top" alt="image for this pizza" width="249px" height="270px">
                        <div class="card-body">
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/veg-'.$pizzaId. '.png" class="card-img-top" alt="image for this pizza" width="249px" height="270px">
                        <div class="card-body">
