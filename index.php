    ...
    <div class="row" style="display:flex; justify-content: center; align-items: center; flex-direction: row;">
      ...
      <?php 
        ...
        while($row = mysqli_fetch_assoc($result)){
          ...
          echo '<div class="col-xs-3 col-sm-3 col-md-3" style="margin:20px ;text-align:center;">
                  <div class="card" style="width: 18rem;">
                    <img src="img/carrdd-'.$id. '.png" class="card-img-top" alt="image for this category" width="249px" height="270px">
                    <div class="card-body">
